      ...
      <div className="mt-6 grid gap-6 lg:grid-cols-[230px_1fr]">
        ...
        <aside className="lg:sticky lg:top-24 lg:self-start">
          <div className="card p-2">
            <nav className="flex gap-1 lg:flex-col" aria-label="منوی حساب کاربری">
              {tabs.map((t) => (
                <button
                  key={t.id}
                  type="button"
                  ...
                  className={cn(
                    "flex flex-1 items-center gap-2 rounded-xl px-3 py-2.5 text-sm font-bold transition-colors lg:flex-none",
                    tab === t.id ? "bg-accent/10 text-accent" : "text-muted hover:bg-surface2 hover:text-fg"
                  )}
                >
