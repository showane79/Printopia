...
import { Cart, Check, ChevronDown, Cube, Eye, Truck } from "@/components/icons";
          ...
          >
            <img
              ...
              style={{
                ...
                transform: spin360 ? "none" : zoom.active ? "scale(1.7)" : "scale(1)",
                animation: spin360 ? "spin360 6s linear infinite" : undefined,
                transition: spin360 ? "none" : "transform 0.2s ease",
              }}
            ...
            <button
              type="button"
              onClick={() => setSpin360((s) => !s)}
              className={cn(
                "touch glass absolute bottom-3 end-3 flex items-center gap-2 rounded-xl border border-line px-3 py-2 text-sm font-bold transition",
                spin360 ? "text-accent" : "text-fg"
              )}
              aria-pressed={spin360}
            >
              <Cube className="h-4 w-4" /> نمای ۳۶۰°
            </button>
            {!spin360 && (
