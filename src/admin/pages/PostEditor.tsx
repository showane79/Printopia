...
export default function PostEditor() {
  ...
  return (
    <div>
      ...
      {/* cover picker */}
      <Modal open={coverPicker} onClose={() => setCoverPicker(false)} title="انتخاب تصویر" size="lg">
        <div className="max-h-[70vh] overflow-auto p-4">
          {localMedia.list().length === 0 ? <p className="py-8 text-center text-sm text-muted">رسانه‌ای موجود نیست.</p> : (
